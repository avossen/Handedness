...
#SBATCH -o /pic/projects/belle/voss771/handOut/AsymCompOut/O_subMC_ex45_on_resonance_uds.out
#SBATCH -e /pic/projects/belle/voss771/handOut/AsymCompOut/O_subMC_ex45_on_resonance_uds.err
#SBATCH -J AsymComp_subMC_ex45_on_resonance_uds
...
/people/voss771/handedness/AsymCompCompiledG1T/TwoHadAsymsCMod /pic/projects/belle/voss771/subMC_ex45_on_resonance_uds mc
cp *45*uds*.root /pic/projects/belle/voss771/AsymmetriesMC/
