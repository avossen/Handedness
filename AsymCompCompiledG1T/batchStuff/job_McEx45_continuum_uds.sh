...
#SBATCH -o /pic/projects/belle/voss771/handOut/AsymCompOut/O_subMC_ex45_continuum_uds.out
#SBATCH -e /pic/projects/belle/voss771/handOut/AsymCompOut/O_subMC_ex45_continuum_uds.err
#SBATCH -J AsymComp_subMC_ex45_continuum_uds
...
/people/voss771/handedness/AsymCompCompiledG1T/TwoHadAsymsCMod /pic/projects/belle/voss771/subMC_ex45_continuum_uds mc
