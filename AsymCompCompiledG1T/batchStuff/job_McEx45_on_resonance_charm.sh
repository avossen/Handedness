...
#SBATCH -o /pic/projects/belle/voss771/handOut/AsymCompOut/O_subMC_ex45_on_resonance_charm.out
#SBATCH -e /pic/projects/belle/voss771/handOut/AsymCompOut/O_subMC_ex45_on_resonance_charm.err
#SBATCH -J AsymComp_subMC_ex45_on_resonance_charm
...
/people/voss771/handedness/AsymCompCompiledG1T/TwoHadAsymsCMod /pic/projects/belle/voss771/subMC_ex45_on_resonance_charm mc
cp *45*charm*.root /pic/projects/belle/voss771/AsymmetriesMC/
