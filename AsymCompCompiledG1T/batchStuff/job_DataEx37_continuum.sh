...
#SBATCH -o /pic/projects/belle/voss771/handOut/AsymCompOut/O_subData_ex37_continuum.out
#SBATCH -e /pic/projects/belle/voss771/handOut/AsymCompOut/O_subData_ex37_continuum.err
#SBATCH -J AsymComp_subData_ex37_continuum
...
/people/voss771/handedness/AsymCompCompiledG1T/TwoHadAsymsCMod /pic/projects/belle/voss771/subData_ex37_continuum
