...
#SBATCH -o /pic/projects/belle/voss771/handOut/AsymCompOut/O_subMC_ex11_continuum_charm.out
#SBATCH -e /pic/projects/belle/voss771/handOut/AsymCompOut/O_subMC_ex11_continuum_charm.err
#SBATCH -J AsymComp_subMC_ex11_continuum_charm
...
/people/voss771/handedness/AsymCompCompiledG1T/TwoHadAsymsCMod /pic/projects/belle/voss771/subMC_ex11_continuum_charm mc
