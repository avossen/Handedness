...
#SBATCH -o /pic/projects/belle/voss771/handOut/AsymCompOut/O_subData_ex35_on_resonance.out
#SBATCH -e /pic/projects/belle/voss771/handOut/AsymCompOut/O_subData_ex35_on_resonance.err
#SBATCH -J AsymComp_subData_ex35_on_resonance
...
/people/voss771/handedness/AsymCompCompiledG1T/TwoHadAsymsCMod /pic/projects/belle/voss771/subData_ex35_on_resonance
find . -iname '*35*.root' -amin -60 -print0 
find . -iname '*35*.root' -amin -60 -exec cp {} /pic/projects/belle/voss771/AsymmetriesData/ \;
